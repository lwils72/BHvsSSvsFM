function d = grdinfo(file);
%GRDINFO  Print information about a GMT grdfile (netCDF format, GMT v3 or v4)
%
...
%
% GRDINFO('file.grd') will display information about the GMT grid
